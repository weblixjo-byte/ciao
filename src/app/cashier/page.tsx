  ...
  if (loadingSession) {
    return (
      <div className="min-h-screen bg-[#FAFBFA] flex items-center justify-center">
        <div className="w-8 h-8 rounded-full border-2 border-neutral-300 border-t-[#426E49] animate-spin" />
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-[#FAFBFA] flex flex-col justify-between p-4 sm:p-6 select-none font-sans">
          ...
          <div className="glass-panel rounded-3xl p-6 sm:p-7 shadow-xl">
            ...
            <form onSubmit={handleCashierLogin} className="space-y-4">
              ...
              <button
                ...
                className="w-full py-3.5 rounded-xl bg-[#426E49] text-white text-sm font-bold hover:bg-[#35593b] transition-all disabled:opacity-50 mt-2 flex items-center justify-center gap-2 cursor-pointer shadow-sm active:scale-98 font-sans"
              >
          ...
          {!isStandaloneApp && (
            <div className="mt-4 p-3.5 rounded-2xl glass-panel-subtle border border-neutral-200 shadow-2xs flex items-center justify-between gap-3">
              <div className="flex items-center gap-2.5 min-w-0">
                <div className="w-8 h-8 rounded-xl bg-emerald-50 text-[#426E49] flex items-center justify-center shrink-0">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-xl bg-[#426E49] text-white text-xs font-bold shrink-0 hover:bg-[#35593b] transition-all cursor-pointer shadow-2xs font-sans"
              >
                Install
              </button>
            </div>
            ...
            <div className="glass-panel rounded-3xl p-6 max-w-sm w-full shadow-2xl relative animate-in fade-in zoom-in-95 duration-200">
              ...
              <div className="space-y-3 glass-panel-subtle rounded-2xl p-4 text-xs text-neutral-800 font-sans">
                <div className="flex items-start gap-2.5">
                  ...
                  <span>Tap the <strong>Share</strong> button <Share2 className="w-3.5 h-3.5 inline mx-0.5 text-[#426E49]" /> in Safari or <strong>Menu (⋮)</strong> in Chrome.</span>
                </div>
                <div className="flex items-start gap-2.5">
              ...
              <button
                type="button"
                onClick={() => setShowInstallGuide(false)}
                className="w-full mt-4 py-2.5 rounded-xl bg-[#426E49] text-white text-xs font-bold hover:bg-[#35593b] transition-colors cursor-pointer font-sans"
              >
                Got It
              </button>
            </div>
        ...
        <div className="text-center text-xs text-neutral-500 py-4 flex items-center justify-center gap-4">
          <Link href="/admin" className="hover:text-[#426E49] font-semibold transition-colors">
            Admin Console
          </Link>
          <span className="text-neutral-300">•</span>
          <Link href="/customer" className="hover:text-[#426E49] font-semibold transition-colors">
            Customer Pass
          </Link>
        </div>
      </div>
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            {!isStandaloneApp && (
              <button
                type="button"
                onClick={handleInstallClick}
                className="px-2.5 sm:px-3 py-1.5 rounded-xl border border-neutral-200 glass-panel-subtle hover:bg-white text-xs font-semibold text-[#426E49] flex items-center gap-1.5 transition-all cursor-pointer shadow-2xs font-sans"
                title="Install Cashier POS App"
              >
                <Smartphone className="w-3.5 h-3.5 text-[#426E49]" />
            ...
            >
              <RefreshCw className="w-3.5 h-3.5 text-[#426E49]" />
          ...
          <div className="w-full max-w-md mx-auto space-y-3.5">
            ...
            <div className="grid grid-cols-2 gap-2 glass-panel-subtle p-1 rounded-2xl border border-neutral-200">
              <button
                ...
                className={`py-2.5 px-3 rounded-xl font-bold text-xs flex items-center justify-center gap-2 transition-all cursor-pointer font-sans ${
                  activeMode === "pin"
                    ? "bg-[#426E49] text-white shadow-xs"
            ...
            {activeMode === "pin" && (
              <div className="glass-panel rounded-3xl p-4 sm:p-5 shadow-lg space-y-4">
                      ...
                      return (
                        <div
                          ...
                          className={`w-10 h-12 sm:w-12 sm:h-14 rounded-xl border-2 flex items-center justify-center text-xl font-bold font-mono transition-all ${
                            char
                              ? "border-[#426E49] bg-emerald-50 text-[#426E49]"
                              : idx === pinQuery.length
                              ? "border-[#426E49] bg-white animate-pulse"
                ...
                <button
                  ...
                  className="w-full py-3.5 rounded-2xl bg-[#426E49] text-white text-sm font-bold hover:bg-[#35593b] transition-all disabled:opacity-40 cursor-pointer shadow-xs flex items-center justify-center gap-2 active:scale-98 font-sans"
                >
                  {lookupLoading ? (
                    <>
            ...
            {activeMode === "qr" && (
              <div className="glass-panel rounded-3xl p-5 sm:p-6 shadow-lg space-y-4 text-center">
                <div className="w-16 h-16 rounded-full bg-emerald-50 border border-emerald-100 text-[#426E49] flex items-center justify-center mx-auto">
                ...
                <button
                  ...
                  className="w-full py-4 px-4 rounded-2xl bg-[#426E49] hover:bg-[#35593b] text-white text-sm font-bold flex items-center justify-center gap-2.5 transition-all shadow-md active:scale-98 cursor-pointer font-sans"
                >
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2.5 rounded-xl bg-[#426E49] text-white text-xs font-bold hover:bg-[#35593b] transition-colors disabled:opacity-40 cursor-pointer shrink-0 font-sans"
                  >
            ...
            <div className="glass-panel rounded-3xl p-4 sm:p-5 shadow-lg">
              <div className="flex items-center justify-between gap-3 mb-3">
                <div className="flex items-center gap-3 min-w-0">
                  <div className="w-12 h-12 rounded-2xl bg-emerald-50 border border-emerald-100 flex items-center justify-center text-[#426E49] text-xl font-bold shrink-0">
              ...
              <div className="glass-panel-subtle rounded-2xl p-3 flex items-center justify-between">
                <div>
                  ...
                  <div className="flex items-baseline gap-1">
                    <span className="text-2xl font-black text-[#426E49] font-sans">
                ...
                <div className="text-right bg-white/80 px-3 py-1.5 rounded-xl border border-neutral-200 shadow-2xs">
                  ...
                  <span className="text-xs font-bold text-[#426E49] font-sans">
                ...
                <form onSubmit={handleCreditPoints} className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative flex items-center">
                      <input
                        ...
                        required
                      />
                      <span className="absolute right-3 px-2.5 py-1 rounded-xl bg-neutral-100 border border-neutral-200 text-xs font-bold text-[#426E49] font-sans pointer-events-none">
                        {config.currency}
                      </span>
                    </div>
                  ...
                  <div className="p-3.5 glass-panel-subtle rounded-2xl flex items-center justify-between">
                    <div className="flex items-center gap-1.5 text-xs font-bold text-neutral-900 font-sans">
                      <Sparkles className="w-4 h-4 text-[#426E49]" />
                      <span>Points to be Earned:</span>
                    </div>
                    <span className="text-base font-black font-sans text-[#426E49]">
                  ...
                  <div className="flex gap-2.5 pt-1">
                    ...
                    <button
                      ...
                      className="flex-1 py-3.5 rounded-2xl bg-[#426E49] hover:bg-[#35593b] text-white text-sm font-bold transition-all disabled:opacity-40 flex items-center justify-center gap-2 shadow-sm cursor-pointer active:scale-98 font-sans"
                    >
                      {transactLoading ? (
                        <>
                          <div className="w-4 h-4 rounded-full border-2 border-white/20 border-t-white animate-spin" />
            ...
            {actionTab === "redeem" && (
              <div className="glass-panel rounded-3xl p-5 sm:p-6 shadow-lg space-y-4">
                <div>
                  ...
                  <p className="text-[11px] text-neutral-500 font-sans">
                    Deduct points from customer balance for pasta, pizza, beverage, or bill discount.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2.5 pt-1">
                    ...
                    <button
                      ...
                      className="flex-1 py-3.5 rounded-2xl bg-[#426E49] hover:bg-[#35593b] text-white text-sm font-bold transition-all disabled:opacity-40 cursor-pointer shadow-sm active:scale-98 flex items-center justify-center gap-2 font-sans"
                    >
                      {redeemLoading ? (
                        <>
                          <div className="w-4 h-4 rounded-full border-2 border-white/20 border-t-white animate-spin" />
        ...
        {receipt && (
          <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
            <div className="glass-panel rounded-3xl p-5 sm:p-7 max-w-sm w-full shadow-2xl text-center animate-in fade-in zoom-in-95 duration-200">
              <div className="w-14 h-14 rounded-full bg-emerald-50 border-2 border-emerald-100 text-[#426E49] flex items-center justify-center mx-auto mb-3 shadow-xs">
                <CheckCircle2 className="w-8 h-8 text-[#426E49]" />
              </div>
              ...
              <div className="glass-panel-subtle rounded-2xl p-4 mb-5 text-left space-y-2 text-xs">
                ...
                <div className="pt-2 border-t border-neutral-200 flex justify-between font-extrabold text-sm">
                  ...
                  <span className="font-sans font-bold text-[#426E49]">{receipt.newBalance} pts</span>
                </div>
              ...
              <button
                onClick={resetPOS}
                className="w-full py-3.5 rounded-2xl bg-[#426E49] hover:bg-[#35593b] text-white text-sm font-bold transition-all shadow-md active:scale-98 cursor-pointer flex items-center justify-center gap-2 font-sans"
              >
