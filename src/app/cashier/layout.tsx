...
export const metadata: Metadata = {
  title: "ciao ciao Cashier POS Terminal",
  description: "Point of Sale & Loyalty Scanner for ciao ciao Staff",
  applicationName: "ciao ciao Cashier",
  appleWebApp: {
    capable: true,
    statusBarStyle: "black-translucent",
    title: "ciao ciao Cashier",
  },
  icons: {
    apple: [
  ...
  other: {
    "application-name": "ciao ciao Cashier POS",
  },
};
